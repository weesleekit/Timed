...
#pragma warning restore IDE0067 // Dispose objects before losing scope
        ...
        private void ButtonPrivacy_Click(object sender, EventArgs e)
        {
            MessageBox.Show(
                ...
                Environment.NewLine + Environment.NewLine +
                "This application is open source and can be found here ... . If any of the above concerns you then you can easily download the source code, check it and compile it yourself.",
                "Privacy Statement",
